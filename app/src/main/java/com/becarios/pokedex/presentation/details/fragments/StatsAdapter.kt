...
class StatsAdapter(private val pokemonsStats: List<PokemonsStats>, val onItemClickListener: ((pokemon: PokemonsStats) -> Unit)
) : RecyclerView.Adapter<StatsAdapter.PokemonsViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PokemonsViewHolder { val view =
    ...
    class PokemonsViewHolder(itemView: View, private val onItemClickListener: ((pokemon: PokemonsStats) -> Unit)
